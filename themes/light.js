    ...
    <div id="msco-aura" style="background: #ffffff; color: #0a0a0c; min-height: 100vh; font-family: 'Inter', 'Helvetica Neue', Arial, sans-serif; display: flex; flex-direction: column; overflow-x: hidden; width: 100%; box-sizing: border-box; -webkit-text-size-adjust: 100%; text-size-adjust: 100%;">
      ...
      <header id="main-header" style="padding: 10px 5%; display: flex; justify-content: space-between; align-items: center; position: fixed; width: 100%; box-sizing: border-box; z-index: 2000; background: rgba(255, 255, 255, 0.85); backdrop-filter: blur(20px); border-bottom: 1px solid rgba(0, 0, 0, 0.05); transition: all 0.3s ease;">
        <div style="cursor: pointer; width: 100px; height: 100px; display: flex; align-items: center;" onclick="window.scrollTo({top: 0, behavior: 'smooth'})">
          <img src="/assets/mcso_star_badge_new.png" alt="MCSO Logo" style="width: 100%; height: 100%; object-fit: contain; filter: invert(0);">
        </div>
      ...
      <main style="flex: 1;">
        ...
        <section id="about" style="padding: 150px 0 0 0; background: #ffffff; position: relative;">
          ...
          <style>
             ...
             .ed-image img { width: 100%; height: 100%; object-fit: cover; filter: brightness(1.1); transition: all 1.2s cubic-bezier(0.16, 1, 0.3, 1); position: absolute; inset: 0; }
             .editorial-row:hover .ed-image img { filter: brightness(1.15); transform: scale(1.05); }
          ...
          <div class="editorial-row">
             ...
             <div class="ed-text ed-text-alt">
                ...
                <h3 style="font-size: 2.5rem; font-weight: 200; margin-bottom: 30px; line-height: 1.2; color: #0a0a0c; text-align: center;">A Calling for <span style="font-style: italic; color: #c9a53d;">Service.</span></h3>
          ...
          <div class="editorial-row reverse-mobile">
             <div class="ed-text">
                ...
                <h3 style="font-size: 2.5rem; font-weight: 200; margin-bottom: 30px; line-height: 1.2; color: #0a0a0c; text-align: center;">Natural Born <span style="font-style: italic; color: #c9a53d;">Leader.</span></h3>
          ...
          <div class="editorial-row">
             ...
             <div class="ed-text ed-text-alt">
                ...
                <h3 style="font-size: 2.5rem; font-weight: 200; margin-bottom: 30px; line-height: 1.2; color: #0a0a0c; text-align: center;">Exceeding <span style="font-style: italic; color: #c9a53d;">Expectations.</span></h3>
          ...
          <div class="editorial-row reverse-mobile">
             <div class="ed-text">
                ...
                <h3 style="font-size: 2.5rem; font-weight: 200; margin-bottom: 30px; line-height: 1.2; color: #0a0a0c; text-align: center;">Modern <span style="font-style: italic; color: #c9a53d;">Leadership.</span></h3>
        ...
        <section id="pathways" style="padding: 150px 10%; background: #ffffff; border-top: 1px solid rgba(0,0,0,0.03); width: 100%; box-sizing: border-box;">
           <div style="max-width: 1400px; margin: 0 auto; width: 100%; box-sizing: border-box;">
              ...
              <style>
                 ...
                 .service-card .card-img { position: absolute; inset: 0; filter: brightness(1.1); transition: all 1.2s cubic-bezier(0.16, 1, 0.3, 1); opacity: 0.8; }
                 .service-card:hover .card-img { filter: brightness(1.15); transform: scale(1.05); opacity: 1; }
        ...
        <section id="lookbook" style="padding: 150px 0; background: #ffffff; overflow: hidden; border-bottom: 1px solid rgba(0,0,0,0.03);">
           ...
           <style>
             ...
             .gallery-item img { width: 100%; height: 100%; object-fit: cover; transition: transform 1.2s cubic-bezier(0.16, 1, 0.3, 1), filter 1.2s ease; filter: contrast(1) brightness(1); }
           ...
           <div id="lightbox">
              ...
              <div id="lightbox-next" style="position: absolute; right: 40px; color: #0a0a0c; font-size: 3rem; font-weight: 100; z-index: 3001; cursor: pointer; opacity: 0.5; transition: opacity 0.3s;">›</div>
               ...
               <div id="lightbox-info" style="position: absolute; bottom: 50px; left: 50%; transform: translateX(-50%); text-align: center; color: #0a0a0c; width: 80%; max-width: 600px; pointer-events: none;">
                  <h4 id="lightbox-label" style="color: #c9a53d; font-size: 0.8rem; letter-spacing: 4px; text-transform: uppercase; margin-bottom: 15px; font-weight: 800;"></h4>
           ...
           <div class="consultation-grid" style="max-width: 1100px; margin: 0 auto; background: #fcfcfc; border: 1px solid rgba(0,0,0,0.05); border-radius: 4px; padding: 80px; display: grid; grid-template-columns: 1fr 1fr; gap: 80px; box-shadow: 0 40px 100px rgba(0,0,0,0.03);">
              <div>
                 ...
                 <div style="display: flex; flex-direction: column; gap: 15px;">
                     <div style="font-size: 2rem; font-weight: 300; color: #0a0a0c; letter-spacing: 1px;">${siteData.contact.phone}</div>
                     <div style="font-size: 0.9rem; color: #999; letter-spacing: 3px; text-transform: uppercase;">${siteData.contact.location}</div>
                 </div>
              </div>
      ...
      <footer style="padding: 100px 10% 60px 10%; border-top: 1px solid rgba(0,0,0,0.03); background: #ffffff; text-align: center;">
         <div style="margin-bottom: 30px; display: flex; justify-content: center;">
            <img src="/assets/mcso_star_badge_new.png" alt="MCSO Logo" style="width: 240px; height: 240px; object-fit: contain; opacity: 0.8; filter: invert(0);">
         </div>
         <p style="color: #999; font-size: 0.75rem; letter-spacing: 2px; text-transform: uppercase;">LICENSED & INSURED IN FLORIDA & NEW YORK // RESPOND // RESPECT // RESOLVE</p>
         ...
         galleryItems.forEach((item, index) => {
            ...
            item.addEventListener('click', () => {
               if (window.innerWidth > 768 && lightbox) {
                  ...
                  galleryItems.forEach(f => f.style.borderColor = 'rgba(201, 165, 61, 0.05)');
                  item.style.borderColor = 'rgba(201, 165, 61, 0.8)';
               }
            });
         });
            ...
            const bObserver = new IntersectionObserver((entries) => {
               entries.forEach(entry => {
                  if (entry.isIntersecting) {
                     entry.target.style.borderColor = 'rgba(201, 165, 61, 0.8)';
                  } else {
                     entry.target.style.borderColor = 'rgba(201, 165, 61, 0.05)';
                  }
               });
